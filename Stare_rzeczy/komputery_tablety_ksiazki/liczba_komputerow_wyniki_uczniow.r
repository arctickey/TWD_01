#Skrypt analizy wplywu dostepnosci komputerow na wyniki uczniow
...
means_math <- group_by(df, ST012Q06NA) %>%
...
means_read <- group_by(df, ST012Q06NA) %>%
...
means_scie <- group_by(df, ST012Q06NA) %>%
